...
insert into Product 
values( 1,'TV','Television or TV is a telecommunication medium for transmitting moving images and sound.'),
		     ( 2,'Computer','A computer is a digital electronic machine that can be used in Programming.'),
             (3,'Desk','A desk or bureau is a piece of furniture that we use our daily life.'),
             (4,'Printers','Laser Printers and inkjet Printers  are two main types we all see in market.');
             
select * from Product;

insert into Suppliers
values(1,'Ganesh Electronics','Jalgoan'),
             (2,'Ekvira Electronics','Dhule'),
             (3,'Gajanan Electronics','Delhi'),
             (4,'Shivay Furnitures','Nashik');
